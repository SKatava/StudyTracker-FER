    ...
    static const std::vector<std::string>& GetTables() {
        static std::vector<std::string> tables = {
            R"(CREATE TABLE IF NOT EXISTS subjects (
                    ...
                    lecture_minutes_needed INTEGER NOT NULL,
                    study_minutes_needed INTEGER NOT NULL,
                    lecture_minutes_done INTEGER NOT NULL,
                    study_minutes_done INTEGER NOT NULL,
                    tasks_minutes_done INTEGER NOT NULL,
